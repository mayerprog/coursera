...
function query(collection) {
    // Получаем операции
    var operations = [].slice.call(arguments, 1); // второй аргумент означает, с какого элемента мы начинаем итерироваться
    ...
    //resultCollection - исходное значение вызова функции и в то же время промежуточный результат, operation - текущий элемент массива operation
